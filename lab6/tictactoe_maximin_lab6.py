# tictactoe_maximin_lab6.py
# extended from tictactoe_basic.py;Feb 2019
# LAB: add "maximin" which is minimax from viewpoint of oppenent (O-player)
...
class T3():
    ...
    def maximin_O(self):
        ...
        next_boards_for_O = self.ttts_for_O()
    ...
    # LAB 6
    # return a list of tuples (place,newT3) where place is one
    # possible place for an O, and newT3 is a T3 object after
    # O took that place;
    def ttts_for_O(self):
        places_for_O = []
        # generate list if a..i that an take an O
        # ...                                   

        ttts_for_O = []
        # generate list of (place, newT3), place in a..i 
        # ...
        print "... O maximins with at %s" % ttts_for_O
        return ttts_for_O
    ...
    def max_for_X_under_O(self,Oboard):
        places_for_X = []
        # generate all places for X
        # .. .
        maxeval = -100000
        # amoung all places for X find the
        # one with highest eval; return
        # that highest value;
        # ...
        return maxeval
